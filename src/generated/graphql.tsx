...
export type CommentRespFragment = {
    __typename?: "CommentResponse";
    hasMore: boolean;
    comment: {
        __typename?: "Comment";
...
export type GetUserQuery = {
    ...
    getUser: {
        ...
        accQuacks?: number | null | undefined;
        posts: Array<{
            __typename?: "Post";
            id: string;
            createdAt: string;
...
export function useSavePostMutation() {
    return Urql.useMutation<SavePostMutation, SavePostMutationVariables>(
        SavePostDocument
    );
}
...
export function useSavedQuery(
    options: Omit<Urql.UseQueryArgs<SavedQueryVariables>, "query"> = {}
) {
